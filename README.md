...
AI Engineer specializing in **secure AI architecture** and **adversarial robustness**. I build high-performance AI systems with defense-in-depth strategies against emerging LLM exploitation vectors and autonomous agent threats.

**Current Focus:**
- 🔐 LLM security hardening & prompt injection mitigation
- 🤖 AI agent threat modeling & containment strategies  
- ⚡ Scalable backend systems for mission-critical SaaS
- 🛡️ Secure-by-design AI application architecture
